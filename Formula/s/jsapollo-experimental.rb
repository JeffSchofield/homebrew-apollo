...
class JsapolloExperimental < Formula
  desc "Self-hosted game stream host for Moonlight"
  homepage "https://app.lizardbyte.dev/Sunshine"
  url "https://github.com/JeffSchofield/Apollo.git", branch: "experimental"
  version Utils.git_head
  license all_of: ["GPL-3.0-only"]
  head "https://github.com/JeffSchofield/Apollo.git", branch: "experimental"
  ...
  def install
    ...
    args = %W[
      ...
      -DSUNSHINE_PUBLISHER_NAME='JeffSchofield'
